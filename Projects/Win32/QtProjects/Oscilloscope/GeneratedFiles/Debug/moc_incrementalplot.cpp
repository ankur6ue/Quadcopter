...
#include "../../../../qwt-6.1.1/examples/realtime/incrementalplot.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_IncrementalPlot_t, stringdata) + ofs \
...
const QMetaObject IncrementalPlot::staticMetaObject = {
    { &QwtPlot::staticMetaObject, qt_meta_stringdata_IncrementalPlot.data,
      qt_meta_data_IncrementalPlot,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_IncrementalPlot.stringdata))
